...
export default function Page() {
  const faqItems = [
    ...
    { q: 'ESTA公式サイトについて', a: 'CBP(アメリカ合衆国税関・国境警備局)公式サイトからESTA(エスタ)を申請する場合は、こちらよりお手続きください。公式サイトは日本語表示に切り替えることが可能ですが、審査はCBPが行うため、申請フォームへの入力はすべて英語(ローマ字)で行う必要があります。また、問い合わせ対応も英語のみとなるためご注意ください。 US ESTA Apply Websiteでは、日本語でのお問い合わせ対応や、分かりづらい入力項目のサポートを通じて、お客様のESTA申請（お申し込み）を日本語でサポートいたします。' },
  ];
    ...
    <div>
      ...
      <section className="section-white py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-gray-600 leading-relaxed mb-4">ESTAを取得せずに出発日を迎えると、飛行機への搭乗およびアメリカへの入国が認められないため、ご注意ください。DHS(アメリカ国土安全保障省)では、出発3日前までに申請手続きを完了することを推奨しています。なお、VWP参加国の市民であっても、伝染病に罹患している方や過去に重大な犯罪歴がある方はESTA申請の対象外となります。また、留学・就労・永住を目的として渡米する方も対象外となるため、渡航目的に応じた適切なビザの取得が必要です。</p>
        </div>
      </section>
