...
const PAGE_TITLE = '【記入例付き】ESTA(エスタ)の申請方法を解説 | US ESTA Apply Website';
const PAGE_DESCRIPTION = 'ESTA(エスタ)の申請では、氏名や生年月日など個人情報の入力が求められます。本記事では、申請をスムーズに進められるよう、記入例を交えて申請方法を紹介します。';
