...
入国審査についても紹介</h1>
        ...
        <div className="bg-[#f8fafc] border border-gray-200 rounded-lg p-5 my-6">
          ...
          <ul className="space-y-2 text-sm">
            <li className="text-gray-600 flex items-start gap-2"><span className="text-[#c41e3a] mt-0.5 flex-shrink-0">▸</span><span>グアム渡航におけるESTAの必要性</span></li>
            ...
            <li className="text-gray-600 flex items-start gap-2"><span className="text-[#c41e3a] mt-0.5 flex-shrink-0">▸</span><span>ESTA申請ステータスの確認手順</span></li>
            <li className="text-gray-600 flex items-start gap-2"><span className="text-[#c41e3a] mt-0.5 flex-shrink-0">▸</span><span>グアム入国時に必要な書類</span></li>
            <li className="text-gray-600 flex items-start gap-2"><span className="text-[#c41e3a] mt-0.5 flex-shrink-0">▸</span><span>グアム入国におけるESTAを取得するメリットについて</span></li>
            <li className="text-gray-600 flex items-start gap-2"><span className="text-[#c41e3a] mt-0.5 flex-shrink-0">▸</span><span>グアム税関より入国に際しての注意事項</span></li>
            <li className="text-gray-600 flex items-start gap-2"><span className="text-[#c41e3a] mt-0.5 flex-shrink-0">▸</span><span>グアム入国手続きの手順</span></li>
          </ul>
        </div>
        ...
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">ESTA申請ステータスの確認手順</h3>
...
当サイトを通じてESTAを申請された方に限り、申請ステータスの確認が可能です。申請状況を確認する際は、当サイトの「申請状況確認画面」にて、名前・生年月日・33桁の申請IDをご入力ください。申請IDは、ESTA申請完了後に当サイトから送信される「申請受付完了メール」にて確認できます。なお、審査結果の確認には申請IDが必要となるため、ESTA申請後は本メールを大切に保管してください。また、申請IDを利用した申請ステータスの確認は、ESTA申請日から90日間有効です。90日を経過すると、個人情報保護の観点から確認できなくなります。</p>
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">グアム入国時に必要な書類</h3>
...
グアムデジタル税関申告書(EDF)は、グアム税関検疫局公式サイトから、パソコンまたはスマートフォンで申請手続きが可能です。</p>
        ...
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">米国CBPでESTAの事前申請を推奨</h3>
        ...
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">グアム入国におけるESTAを取得するメリットについて</h3>
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">最大90日間のグアム滞在が可能</h3>
...
CBP(アメリカ合衆国税関・国境警備局)では、空港での入国手続きを簡略化することを目的としてESTAの取得を推奨しており、ESTAを取得済みの方は、グアム渡航時におけるGuam-CNMI ETAの申請が免除されます。</p>
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">グアム税関より入国に際しての注意事項</h3>
...
外見だけでは薬の詳細が判断できない場合、誤って規制薬物と疑われる可能性もあるため、事前に薬剤携行証明書(英文)を準備しておくことをおすすめします。持ち込みが禁止されている医薬品の成分については、グアム税関検疫局へ事前にお問い合わせください。</p>
        ...
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">グアム国際空港からのアクセス方法</h3>
        ...
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">グアム国際空港の簡易到着システム(Simplified Arrival system)について</h3>
...
同システムでは、パスポートに登録された顔写真と入国審査時に撮影した写真の照合、ならびに採取した指紋の読み取りによって、渡航者の身元確認が行われます。従来必要とされていた書類による審査が簡略化されたことで、渡航者はよりスムーズに入国手続きを行うことが可能となりました。また、簡易到着システムの導入に伴い、グアムを含むアメリカへの渡航歴がある渡航者については、今後の入国審査において指紋採取が不要となります。</p>
        ...
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">グアム入国手続きの手順</h3>
        ...
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">入国手続き</h3>
...
なお、G-CNMI ETAの渡航認証情報はオンライン上で管理されているため、入国審査に提示する必要はありません。ただし、質問にスムーズに回答できるよう、申請完了画面や控えのコピーを 持参しておくことをおすすめします。</p>
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">手荷物の受取</h3>
        ...
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">税関申告の手続き</h3>
