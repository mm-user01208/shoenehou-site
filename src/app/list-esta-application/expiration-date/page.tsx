  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <Breadcrumb items={[{"label": "ESTA申請関連情報一覧", "href": "/list-esta-application"}, {"label": "ESTA(エスタ)の有効期限と再申請・確認の方法"}]} />
        <h1 className="text-3xl font-bold text-gray-900 mb-6">ESTA(エスタ)の有効期限と再申請・確認の方法</h1>
        ...
        <p className="text-gray-600 leading-relaxed mb-4">ESTAの有効期限は原則2年間</p>
        <p className="text-gray-600 leading-relaxed mb-4">ESTAの更新可否</p>
        <p className="text-gray-600 leading-relaxed mb-4">ESTAの申請手順</p>
        <p className="text-gray-600 leading-relaxed mb-4">ESTAの有効期限と再申請</p>
        <p className="text-gray-600 leading-relaxed mb-4">ESTA有効期限のまとめ</p>
        <p className="text-gray-600 leading-relaxed mb-4">ESTAなしでもグアムおよびサイパンへの渡航は可能</p>
        <h3 className="text-xl font-bold text-gray-700 mt-8 mb-3">目次</h3>
        <h3 className="text-xl font-bold text-gray-700 mt-8 mb-3">ESTAの有効期限は原則2年間</h3>
        <p className="text-gray-600 leading-relaxed mb-4">ESTA(エスタ)の有効期限は2年間です。ただし、ESTA申請時に使用したパスポートの有効期限が2年未満の場合は、ESTAもそのパスポートの有効期限と同日に失効するため注意が必要です。そのため、ESTAを申請する前に、必ずパスポートの有効期限を確認することをおすすめします。有効期限が2年未満の場合は、事前にパスポートを更新したうえでESTAを申請しましょう。また、ESTAの審査には一定の時間を要するため、出発日の3日前までに申請することが推奨されています。</p>
        <p className="text-gray-600 leading-relaxed mb-4">ESTAを取得してからアメリカへ渡航するまでに期間が空く場合は、渡航前に必ず有効期限を確認してください。ESTAを取得済みであっても、有効期限が切れている場合は利用できません。万が一、有効期限が切れた状態のESTAを取得したまま出発日を迎えた場合、飛行機への搭乗やアメリカへの入国を拒否されるためご注意ください。</p>
        <h3 className="text-xl font-bold text-gray-700 mt-8 mb-3">ESTAの再申請が必要なケース</h3>
        <p className="text-gray-600 leading-relaxed mb-4">婚姻などにより新たにパスポートを取得した場合や、取得済みのESTA(エスタ)の有効期限が失効した場合は再申請が必要です。ESTAには登録情報や有効期限を更新する制度はありません。これらのケースでは、新たに申請手続きを行う必要があります。今後ESTAを利用してアメリカへの渡航を予定している方は、パスポート情報に変更がないか、またESTAの有効期限が切れていないかを事前に必ず確認してください。パスポート情報と不一致があると判断されたESTAは利用できないため注意が必要です。</p>
        <h3 className="text-xl font-bold text-gray-700 mt-8 mb-3">ESTAの再申請が必要なケース</h3>
        <p className="text-gray-600 leading-relaxed mb-4">婚姻などにより新たにパスポートを取得した場合や、取得済みのESTA(エスタ)の有効期限が失効した場合は再申請が必要です。ESTAには登録情報や有効期限を更新する制度はありません。これらのケースでは、新たに申請手続きを行う必要があります。今後ESTAを利用してアメリカへの渡航を予定している方は、パスポート情報に変更がないか、またESTAの有効期限が切れていないかを事前に必ず確認してください。パスポート情報と不一致があると判断されたESTAは利用できないため注意が必要です。</p>
        <h3 className="text-xl font-bold text-gray-700 mt-8 mb-3">アメリカ滞在中にESTAの有効期限が切れた場合の対応</h3>
...
なお、アメリカで乗り継ぎを行う場合は、有効なESTAに加えて1年以上の有効期限があるパスポートの所持を求められるケースがあります。必要なパスポートの残存有効期限は、乗り継ぎ先の国や航空会社によって異なるため、渡航前に必ず各国の入国条件を確認することをおすすめします。万が一、入国条件を満たさずに乗り継ぎを行った際には、飛行機への搭乗および入国を拒否される可能性があるため注意が必要です。</p>
        <h3 className="text-xl font-bold text-gray-700 mt-8 mb-3">ESTAの有効期限が切れていてもグアム・サイパンへ渡航できる条件</h3>
        ...
        <p className="text-gray-600 leading-relaxed mb-4">このように、ESTAの有効期限が切れている場合でも、渡航目的や滞在日数によってはGuam-CNMI VWPやアメリカビザを利用することで、グアムまたはサイパンへの渡航が認められます。いずれの入国制度もESTAとは利用条件や申請要件が異なるため、渡航前に必ず内容を確認したうえで申請しましょう。</p>
        <h3 className="text-xl font-bold text-gray-700 mt-8 mb-3">ESTAの有効期限が切れていてもグアム・サイパンへ渡航できる条件</h3>
        <p className="text-gray-600 leading-relaxed mb-4">日本国籍者が90日以内の観光や商用、または乗り継ぎを目的としてグアムまたはサイパン(マリアナ諸島)へ渡航する場合、原則としてESTA(エスタ)の申請が求められます。ただし、「グアム-北マリアナ諸島連邦ビザ免除プログラム(Guam-CNMI VWP)」を利用することで、ESTAやビザを取得せずにグアムやサイパンへの渡航が認められる場合があります。Guam-CNMI VWPは、日本を含むアメリカ政府が指定する国の市民を対象とした制度で、45日以内のグアムおよびサイパンへの滞在が認められます。本制度は観光または商用目的に限って利用可能で、渡航前に電子渡航認証「G-CNMI ETA」を申請し、「渡航認証許可」を取得する必要があります。G-CNMI ETAの申請には、有効期限内のパスポートとメールアドレスをご用意ください。一方、45日を超えてのグアムまたはサイパンに滞在する場合は、ESTAの申請か目的に応じたビザの取得が必要となります。</p>
        <p className="text-gray-600 leading-relaxed mb-4">このように、ESTAの有効期限が切れている場合でも、渡航目的や滞在日数によってはGuam-CNMI VWPやアメリカビザを利用することで、グアムまたはサイパンへの渡航が認められます。いずれの入国制度もESTAとは利用条件や申請要件が異なるため、渡航前に必ず内容を確認したうえで申請しましょう。</p>
        <h3 className="text-xl font-bold text-gray-700 mt-8 mb-3">乳幼児・未成年者が同伴する渡航にはESTA申請が必要</h3>
        ...
        <h3 className="text-xl font-bold text-gray-700 mt-8 mb-3">ESTAの有効期限の確認方法</h3>
...
一方、CBP(アメリカ合衆国税関・国境警備局)公式サイトからESTAを申請された方は、当サイトでは有効期限の確認はできません。ESTA申請公式サイトの運営は、CBPおよびDHSの管轄となっているため、当サイトでは認証情報を照会できない仕組みとなっています。そのため、公式サイトから申請された場合は、該当するESTA申請公式サイトへ直接お問い合わせください。</p>
        <h3 className="text-xl font-bold text-gray-700 mt-8 mb-3">ESTAの更新可否</h3>
...
申請手数料の支払いには、各種クレジットカード(Visa、Master Card、JCB、American Express、Diners Club)が利用できます。なお、家族やグループで申請し代表者がまとめて支払う場合は、申請者本人名義以外のクレジットカードでも支払いが可能です。</p>
        <h3 className="text-xl font-bold text-gray-700 mt-8 mb-3">ESTAの有効期限と再申請</h3>
        <h3 className="text-xl font-bold text-gray-700 mt-8 mb-3">ESTAの再申請を行うタイミング</h3>
        <p className="text-gray-600 leading-relaxed mb-4">ESTA(エスタ)の再申請は、いつでも行うことができます。ESTAの有効期限は原則2年間で、有効期限が切れた後はもちろん、有効期限内であっても再申請が可能です。例えば、ESTAを取得した翌日に再度申請することもでき、再申請の回数に制限は設けられていません。ただし、新たにESTAを申請して渡航認証が承認された場合、それまで取得していたESTAの認証情報は無効となるため注意が必要です。ESTAの有効期限は、再申請によって承認された日から起算して、新たに2年間設定されます。</p>
        <h3 className="text-xl font-bold text-gray-700 mt-8 mb-3">ESTA申請情報の修正方法</h3>
...
当サイトを通じてESTAを申請された場合に限り、お申し込み完了後の申請情報の修正依頼を1回まで無料で承っています。修正可能な内容は項目によって対応が異なるため、以下の手順をご確認のうえ、お問い合わせください。</p>
        <p className="text-gray-600 leading-relaxed mb-4">氏名またはパスポート番号を修正する場合</p>
        <p className="text-gray-600 leading-relaxed mb-4">上記に該当しない情報を修正する場合</p>
        <p className="text-gray-600 leading-relaxed mb-4">お問い合わせフォームにて「氏名・申請ID・メールアドレス」を入力したうえで、修正箇所の詳細を記入しお問い合わせください。</p>
        <p className="text-gray-600 leading-relaxed mb-4">再度、ESTA申請をお申し込みください。</p>
        <h4 className="text-lg font-bold text-gray-700 mt-6 mb-2">申請者情報・パスポート情報(発行日および有効期限)・連絡先・滞在先の修正方法</h4>
        <p className="text-gray-600 leading-relaxed mb-4">当サイトを通じてESTA(エスタ)を申請された場合に限り、生年月日・性別・国籍・出生国・パスポート情報(発行日や有効期限)・連絡先・滞在先情報などの変更が可能です。まず、ESTAの申請フォームにて必須項目をすべて入力してください。入力後は登録内容の確認ページで申請情報に不備がないかを確認し、変更内容の確認画面へ進みます。変更内容の確認画面にて、新たな申請情報と既存の申請情報を確認したうえで送信すると、修正依頼は完了となります。
...
万が一、上記の手順で修正手続きが完了できなかった場合にはお問い合わせください。当サイトの問い合わせフォームにて「氏名・申請ID・メールアドレス」を入力のうえ、修正が行えない旨をお問い合わせ内容に記載し送信してください。</p>
        <h4 className="text-lg font-bold text-gray-700 mt-6 mb-2">氏名・パスポート番号の修正方法</h4>
        <p className="text-gray-600 leading-relaxed mb-4">ESTA(エスタ)を申請した際に氏名またはパスポート番号に誤りがあった場合は、当サイトにて修正依頼を承ります。修正を希望する場合は、当サイトの問い合わせフォームへ進み、氏名・申請ID・メールアドレスを入力してください。お問い合わせ内容欄には、氏名またはパスポート番号の修正を希望する旨を記載し、送信しましょう。修正依頼が完了すると、当サイトより新たなESTA申請情報(有効期限・申請番号)を通知します。これらの情報は渡航時に必要となるため、渡航日まで大切に保管してください。</p>
        <h4 className="text-lg font-bold text-gray-700 mt-6 mb-2">犯罪歴などに関する質問事項で誤って回答した場合の修正方法</h4>
...
なお、犯罪歴や逮捕歴の有無によりビザ免除プログラム(VWP)が利用できない場合は、在日米国大使館または総領事館にて渡航目的に応じたビザの取得をご検討ください。ビザ申請後は、大使館または総領事館での面談や審査が行われ、問題がなければビザが発給されます。ただし、アメリカビザは申請から取得までに1か月以上かかることもあるため、余裕を持って手続きを進めることが重要です。有効なESTAまたはアメリカビザのいずれも取得しないまま渡航日を迎えた場合、飛行機の搭乗やアメリカへの入国を拒否される可能性あるため注意が必要です。</p>
        <h3 className="text-xl font-bold text-gray-700 mt-8 mb-3">ESTA再申請後に有効期限の告知メールが届く理由</h3>
...
以下では、CBPから通知されるメールの内容を日本語に翻訳して紹介します。</p>
        <p className="text-gray-600 leading-relaxed mb-4">ESTA Expiration Warning?: ATTENTION! 
Your travel authorization submitted on March 1, 20XX via ESTA will expire within the next 30 days. It is not possible to extend or renew a current ESTA. You will need to reapply at if travel to the United States is intended in the near future. If there are 30 or more days left on the old authorization you will receive a warning message during the application process and be asked if you wish to proceed.</p>
        <p className="text-gray-600 leading-relaxed mb-4">ESTAの有効期限に関する警告
20XX年3月1日にESTA申請された渡航認証は、今後30日以内に有効期限を迎えます。現在有効なESTAを延長または更新することはできません。近い将来にアメリカへの渡航を予定している場合は、ESTAを再申請する必要があります。なお、既存の渡航認証に30日以上の有効期間が残っている場合は、申請手続き中に警告メッセージが表示され、申請を続行するかどうかの確認が求められます。</p>
        <h3 className="text-xl font-bold text-gray-700 mt-8 mb-3">ESTA有効期限のまとめ</h3>
        <h3 className="text-xl font-bold text-gray-700 mt-8 mb-3">ESTAの有効期限は原則2年間</h3>
        <p className="text-gray-600 leading-relaxed mb-4">ESTA(エスタ)の有効期限は、原則として2年間です。ただし、ESTA申請時に使用したパスポートの有効期限が2年未満の場合は、ESTAもそのパスポートの有効期限と同日に失効するため注意が必要です。事前にパスポートの有効期限を確認し、残存期間が2年未満の場合は更新後にESTAを申請しましょう。</p>
        <h3 className="text-xl font-bold text-gray-700 mt-8 mb-3">ESTAの有効期限が切れた場合は再申請が必要</h3>
        <p className="text-gray-600 leading-relaxed mb-4">取得済みのESTA(エスタ)の有効期限が切れており、今後もアメリカへの渡航を予定している場合はESTAを再申請してください。また、アメリカへの入国には、原則として残存有効期間が6か月以上あるパスポートが必要となるため、事前に確認することをおすすめします。残存有効期間が6か月未満の場合は、あらかじめパスポートを更新しておきましょう。なお、有効なアメリカビザを利用して渡航する場合は、ESTAを再申請する必要はありません。</p>
        <h3 className="text-xl font-bold text-gray-700 mt-8 mb-3">ESTAに更新制度はありません</h3>
        ...
        <h3 className="text-xl font-bold text-gray-700 mt-8 mb-3">有効期限内でもESTAの再申請は可能</h3>
        <p className="text-gray-600 leading-relaxed mb-4">取得済みのESTA(エスタ)の有効期限が残っている場合でも、ESTAを再申請することは可能です。例えば、ESTAを取  得した翌日に再申請することもでき、再申請の回数に制限は設けられていません。ただし、新たにESTAが承認された時点で、新しい有効期限と申請番号が発行され、最新のESTAのみが有効となります。そのため、それまで取得していたESTAの認証情報は失効するため注意が必要です。なお、ESTAの認証情報は渡航時に必要となるため、紛失しないよう大切に保管しておきましょう。</p>
        <h3 className="text-xl font-bold text-gray-700 mt-8 mb-3">ESTA再申請後は既存の認証情報が無効になります</h3>
        <p className="text-gray-600 leading-relaxed mb-4">ESTA(エスタ)の有効期限が切れた場合や、新たにパスポートを取得した場合には、ESTAの再申請が必要です。再申請手続きを行い、新 たに渡航認証が承認されると、新しい有効期限と申請番号が発行されます。その時点で、既存のESTA認証情報は取り消され、無効となるため注意が必要です。そのため、有効期限が残っている状態でESTAを再申請する場合は、今後の旅行日程を確認したうえで手続きを行うことをおすすめします。</p>
        <h3 className="text-xl font-bold text-gray-700 mt-8 mb-3">ESTAが有効期限切れでもアメリカから出国することは可能</h3>
        <p className="text-gray-600 leading-relaxed mb-4">ESTA(エスタ)は、短期観光や商用、または乗り継ぎを目的としてアメリカへ渡航する際に必要となる事前渡航認証制度です。有効なESTAは入国時に必要となりますが、出国時にESTAの有効期限が切れていても、原則として出国審査には影響ありません。ただし、アメリカへ入国する際には、有効なESTAに加えて、原則として残存有効期間が6か月以上あるパスポートが必要となります。また、アメリカで乗り継ぎ(トランジット)を行う場合も、有効なESTAが必要となるため注意が必要です。</p>
        <p className="text-gray-600 leading-relaxed mb-4">ESTA再申請のポイント
ESTA(エスタ)の有効期限が切れた場合や、婚姻などにより新たにパスポートを取得  した場合は、ESTAの再申請が必要となります。なお、「ESTAの再申請」は更新手続きではなく、新たに申請を行うものとなるため、申請時には別途手数料の支払いが求められます。また、ESTAの有効期限が残っている状態でも再申請が可能ですが、新たにESTAが承認された時点で、既存の認証情報は失効します。そのため、再申請を行う際は、今後の旅行日程を確認したうえで手続きを進めましょう。なお、アメリカへ入国する際には、有効なESTAに加え、残存有効期間が6か月以上あるパスポートが必要となるため、事前に準備しておくことをおすすめします</p>
        <h3 className="text-xl font-bold text-gray-700 mt-8 mb-3">ESTAなしでもグアムお よびサイパンへの渡航は可能</h3>
        ...
        <p className="text-gray-600 leading-relaxed mb-4">グアムおよびサイパン渡航時の注意点
