      ...
      <Breadcrumb items={[{"label": "ESTA申請関連情報一覧", "href": "/list-esta-application"}, {"label": "ESTA(エスタ)の有効期限と再申請・確認の方法"}]} />
        ...
        <div className="bg-[#f8fafc] border border-gray-200 rounded-lg p-5 my-6">
          ...
          <ul className="space-y-2 text-sm">
            <li className="text-gray-600 flex items-start gap-2"><span className="text-[#c41e3a] mt-0.5 flex-shrink-0">▸</span><span>ESTAの有効期限は原則2年間</span></li>
            <li className="text-gray-600 flex items-start gap-2"><span className="text-[#c41e3a] mt-0.5 flex-shrink-0">▸</span><span>ESTAの更新可否</span></li>
            <li className="text-gray-600 flex items-start gap-2"><span className="text-[#c41e3a] mt-0.5 flex-shrink-0">▸</span><span>ESTAの申請手順</span></li>
            <li className="text-gray-600 flex items-start gap-2"><span className="text-[#c41e3a] mt-0.5 flex-shrink-0">▸</span><span>ESTAの有効期限と再申請</span></li>
            <li className="text-gray-600 flex items-start gap-2"><span className="text-[#c41e3a] mt-0.5 flex-shrink-0">▸</span><span>ESTA有効期限のまとめ</span></li>
            <li className="text-gray-600 flex items-start gap-2"><span className="text-[#c41e3a] mt-0.5 flex-shrink-0">▸</span><span>ESTAなしでもグアムおよびサイパンへの渡航は可能</span></li>
          </ul>
        </div>
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">ESTAの有効期限は原則2年間</h3>
        ...
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">ESTAの再申請が必要なケース</h3>
        ...
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">ESTAの再申請が必要なケース</h3>
        <p className="text-gray-700 leading-relaxed mb-4">婚姻などにより新たにパスポートを取得した場合や、取得済みのESTA(エスタ)の有効期限が失効した場合は再申請が必要です。ESTAには登録情報や有効期限を更新する制度はありません。これらのケースでは、新たに申請手続きを行う必要があります。今後ESTAを利用してアメリカへの渡航を予定している方は、パスポート情報に変更がないか、またESTAの有効期限が切れていないかを事前に必ず確認してください。パスポート情報と不一致があると判断されたESTAは利用できないため注意が必要です。</p>
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">アメリカ滞在中にESTAの有効期限が切れた場合の対応</h3>
        <p className="text-gray-700 leading-relaxed mb-4">ESTAは、CBP(アメリカ合衆国税関・国境警備局)およびDHS(アメリカ国土安全保障省)が管轄する入国審査制度です。ESTAの有効性が確認されるのはアメリカ入国時であるため、滞在中や出国時にESTAの有効期限が切れていても、原則として影響はありません。入国時に承認されていれば、最長90日間のアメリカ滞在が認められます。ただし、アメリカへ入国する際には、滞在期間に加えて原則6か月以上の残存有効期間があるパスポートが必要です。また、ESTAを利用して渡航する場合は、少なくとも出国日まで有効なパスポートを所持していることが求められます。
なお、アメリカで乗り継ぎを行う場合は、有効なESTAに加えて1年以上の有効期限があるパスポートの所持を求められるケースがあります。必要なパスポートの残存有効期限は、乗り継ぎ先の国や航空会社によって異なるため、渡航前に必ず各国の入国条件を確認することをおすすめします。万が一、入国条件を満たさずに乗り継ぎを行った際には、飛行機への搭乗および入国を拒否される可能性があるため注意が必要です。</p>
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">ESTAの有効期限が切れていてもグアム・サイパンへ渡航できる条件</h3>
        ...
        <p className="text-gray-700 leading-relaxed mb-4">日本国籍者が90日以内の観光や商用、または乗り継ぎを目的としてグアムまたはサイパン(マリアナ諸島)へ渡航する場合、原則としてESTA(エスタ)の申請が求められます。ただし、「グアム-北マリアナ諸島連邦ビザ免除プログラム(Guam-CNMI VWP)」を利用することで、ESTAやビザを取得せずにグアムやサイパンへの渡航が認められる場合があります。Guam-CNMI VWPは、日本を含むアメリカ政府が指定する国の市民を対象とした制度で、45日以内のグアムおよびサイパンへの滞在が認められます。本制度は観光または商用目的に限って利用可能で、渡航前に電子渡航認証「G-CNMI ETA」を申請し、「渡航認証許可」を取得する必要があります。G-CNMI ETAの申請には、有効期限内のパスポートとメールアドレスをご用意ください。一方、45日を超えてのグアムまたはサイパンに滞在する場合は、ESTAの申請か目的に応じたビザの取得が必要となります。</p>
        <p className="text-gray-700 leading-relaxed mb-4">このように、ESTAの有効期限が切れている場合でも、渡航目的や滞在日数によってはGuam-CNMI VWPやアメリカビザを利用することで、グアムまたはサイパンへの渡航が認められます。いずれの入国制度もESTAとは利用条件や申請要件が異なるため、渡航前に必ず内容を確認したうえで申請しましょう。</p>
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">乳幼児・未成年者が同伴する渡航にはESTA申請が必要</h3>
        ...
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">ESTAの有効期限の確認方法</h3>
...
一方、CBP(アメリカ合衆国税関・国境警備局)公式サイトからESTAを申請された方は、当サイトでは有効期限の確認はできません。ESTA申請公式サイトの運営は、CBPおよびDHSの管轄となっているため、当サイトでは認証情報を照会できない仕組みとなっています。そのため、公式サイトから申請された場合は、該当するESTA申請公式サイトへ直接お問い合わせください。</p>
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">ESTAの更新可否</h3>
        ...
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">ESTAの申請手順</h3>
...
申請手数料の支払いには、各種クレジットカード(Visa、Master Card、JCB、American Express、Diners Club)が利用できます。なお、家族やグループで申請し代表者がまとめて支払う場合は、申請者本人名義以外のクレジットカードでも支払いが可能です。</p>
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">ESTAの有効期限と再申請</h3>
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">ESTAの再申請を行うタイミング</h3>
        ...
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">ESTA申請情報の修正方法</h3>
...
なお、犯罪歴や逮捕歴の有無によりビザ免除プログラム(VWP)が利用できない場合は、在日米国大使館または総領事館にて渡航目的に応じたビザの取得をご検討ください。ビザ申請後は、大使館または総領事館での面談や審査が行われ、問題がなければビザが発給されます。ただし、アメリカビザは申請から取得までに1か月以上かかることもあるため、余裕を持って手続きを進めることが重要です。有効なESTAまたはアメリカビザのいずれも取得しないまま渡航日を迎えた場合、飛行機の搭乗やアメリカへの入国を拒否される可能性あるため注意が必要です。</p>
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">ESTA再申請後に有効期限の告知メールが届く理由</h3>
...
20XX年3月1日にESTA申請された渡航認証は、今後30日以内に有効期限を迎えます。現在有効なESTAを延長または更新することはできません。近い将来にアメリカへの渡航を予定している場合は、ESTAを再申請する必要があります。なお、既存の渡航認証に30日以上の有効期間が残っている場合は、申請手続き中に警告メッセージが表示され、申請を続行するかどうかの確認が求められます。</p>
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">ESTA有効期限のまとめ</h3>
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">ESTAの有効期限は原則2年間</h3>
        ...
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">ESTAの有効期限が切れた場合は再申請が必要</h3>
        ...
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">ESTAに更新制度はありません</h3>
        ...
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">有効期限内でもESTAの再申請は可能</h3>
        ...
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">ESTA再申請後は既存の認証情報が無効になります</h3>
        ...
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">ESTAが有効期限切れでもアメリカから出国することは可能</h3>
...
ESTA(エスタ)の有効期限が切れた場合や、婚姻などにより新たにパスポートを取得  した場合は、ESTAの再申請が必要となります。なお、「ESTAの再申請」は更新手続きではなく、新たに申請を行うものとなるため、申請時には別途手数料の支払いが求められます。また、ESTAの有効期限が残っている状態でも再申請が可能ですが、新たにESTAが承認された時点で、既存の認証情報は失効します。そのため、再申請を行う際は、今後の旅行日程を確認したうえで手続きを進めましょう。なお、アメリカへ入国する際には、有効なESTAに加え、残存有効期間が6か月以上あるパスポートが必要となるため、事前に準備しておくことをおすすめします</p>
        <h3 className="text-lg font-bold text-[#1a2744] border-b border-gray-200 pb-2 mt-8 mb-4">ESTAなしでもグアムお よびサイパンへの渡航は可能</h3>
