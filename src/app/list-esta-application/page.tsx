...
<section class="section" style="padding-top:72px;padding-bottom:96px">
  <div class="section__inner fade-up">
    <div class="related cat-grid" style="max-width:1240px">
      ...
      <a href="/list-esta-application/when-to-apply"><span class="related__media"><img src="/img/related/when-to-apply.jpg" alt="" loading="lazy"></span><span class="related__body"><span class="related__num">07.</span><span class="related__title">ESTAはいつまでに申請すべき？</span><span class="related__excerpt">ESTAの申請タイミングを解説。審査に最大72時間かかる場合があるため、出発の72時間前までの申請が安心です。いつから申請できるか、直前申請のリスクまでまとめました。</span><span class="related__more">Read more</span></span></a>
      <a href="/list-esta-application/official-cbp"><span class="related__media"><img src="/img/related/official-cbp.jpg" alt="" loading="lazy"></span><span class="related__body"><span class="related__num">08.</span><span class="related__title">ESTA公式ウェブサイトについて解説</span><span class="related__excerpt">CBP(米国税関・国境警備局)が運営するESTA申請の公式ウェブサイトの役割や利用方法、当サイト経由での申請との違いや注意点を詳しく解説します。</span><span class="related__more">Read more</span></span></a>
      <a href="/list-esta-application/cbp-flow"><span class="related__media"><img src="/img/related/cbp-flow.jpg" alt="" loading="lazy"></span><span class="related__body"><span class="related__num">09.</span><span class="related__title">ESTA申請方法と取得手順を徹底解説</span><span class="related__excerpt">CBPは出発の72時間前までの申請を推奨しています。ESTA取得に必要な情報や申請ステップ、認証完了までの一連の流れを丁寧に解説します。</span><span class="related__more">Read more</span></span></a>
      <a href="/list-esta-application/application"><span class="related__media"><img src="/img/related/application.jpg" alt="" loading="lazy"></span><span class="related__body"><span class="related__num">10.</span><span class="related__title">アプリを使ったESTA申請方法を解説</span><span class="related__excerpt">CBP One モバイルアプリを使ったESTA申請の手順や、アプリならではの便利機能、利用時の注意点・対応OSバージョンまで分かりやすく解説します。</span><span class="related__more">Read more</span></span></a>
      <a href="/list-esta-application/status-check"><span class="related__media"><img src="/img/related/status-check.jpg" alt="" loading="lazy"></span><span class="related__body"><span class="related__num">11.</span><span class="related__title">ESTA申請状況の確認方法</span><span class="related__excerpt">ESTA申請後の審査状況や認証結果を確認する方法、姓名・生年月日・申請IDの入力手順、承認や保留・拒否となった場合の対応について解説します。</span><span class="related__more">Read more</span></span></a>
    </div>
  </div>
</section>
