      ...
      <Breadcrumb items={[{"label": "サイト情報一覧", "href": "/list-site-information"}, {"label": "推奨ブラウザについて"}]} />
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          ...
          <div className="grid gap-2">
            <div className="flex items-center gap-2 py-2 px-3 bg-[#f8fafc] rounded hover:bg-[#f0f4f8] transition-colors"><span className="text-[#c41e3a] text-xs">●</span><span className="text-sm text-[#1a2744]">推奨ブラウザ一覧</span></div>
        ...
        <p className="text-gray-700 leading-relaxed mb-4">※ 常に最新版のご利用を推奨します。</p>
            <div className="flex items-center gap-2 py-2 px-3 bg-[#f8fafc] rounded hover:bg-[#f0f4f8] transition-colors"><span className="text-[#c41e3a] text-xs">●</span><span className="text-sm text-[#1a2744]">推奨環境</span></div>
        ...
        <p className="text-gray-700 leading-relaxed mb-4">ポップアップブロック：無効（当サイトのみ）</p>
            <div className="flex items-center gap-2 py-2 px-3 bg-[#f8fafc] rounded hover:bg-[#f0f4f8] transition-colors"><span className="text-[#c41e3a] text-xs">●</span><span className="text-sm text-[#1a2744]">非推奨ブラウザ・環境</span></div>
...
推奨環境以外でのご利用による不具合については、当サイトでは責任を負いかねます。あらかじめご了承ください。</p>
            <div className="flex items-center gap-2 py-2 px-3 bg-[#f8fafc] rounded hover:bg-[#f0f4f8] transition-colors"><span className="text-[#c41e3a] text-xs">●</span><span className="text-sm text-[#1a2744]">動作環境に関する補足事項</span></div>
