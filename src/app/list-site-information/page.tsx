...
const PAGE_PATH = '/list-site-information/';
const PAGE_TITLE = 'サイト情報一覧 | US ESTA Apply Website';
const PAGE_DESCRIPTION = '当サイトの利用に関する各種フォームや規約、運営者情報を一覧でご案内しています。ご利用前に確認しておきたい重要な内容を分かりやすくまとめています。';
