...
export default function Page() {
  return (
    <article className="max-w-4xl mx-auto px-4 py-8">
      ...
      <Breadcrumb items={[{"label": "サイト情報一覧", "href": "/list-site-information"}, {"label": "お問い合わせ"}]} />
        <h1 className="text-2xl md:text-3xl font-bold text-[#1a2744] mb-2 pb-3 border-b-2 border-[#c41e3a]">お問い合わせ</h1>
        <p className="text-gray-700 leading-relaxed mb-4">問い合わせフォームは現在準備中です。
