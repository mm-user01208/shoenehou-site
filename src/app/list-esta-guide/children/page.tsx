    ...
    <article class="article-body">
      ...
      <section id="sec-06" class="fade-up">
        ...
        <div class="faq" style="margin-top:32px">
          <details open>
            <summary>赤ちゃん(0歳)でもESTAの申請は必要ですか？</summary>
          ...
          <details>
            <summary>子供のESTA申請で勤務先には何と入力すればよいですか？</summary>
          ...
          <details>
            <summary>子供のESTA申請に使うメールアドレスは親のものでも大丈夫ですか？</summary>
          ...
          <details>
            <summary>子供のESTAは親のパスポートで申請できますか？</summary>
          ...
          <details>
            <summary>家族全員のESTAをまとめて申請できますか？</summary>
