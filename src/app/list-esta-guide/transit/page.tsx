    ...
    <article class="article-body">
      ...
      <section id="sec-06" class="fade-up">
        ...
        <div class="faq" style="margin-top:32px">
          <details open>
            <summary>Q. アメリカで乗り継ぎだけの場合でもESTAは必要ですか？</summary>
          ...
          <details>
            <summary>Q. アメリカでの乗り継ぎ時間はどれくらい必要ですか？</summary>
          ...
          <details>
            <summary>Q. 乗り継ぎ時に預け荷物は最終目的地まで届きますか？</summary>
          ...
          <details>
            <summary>Q. トランジット目的のESTA申請で滞在先住所は何と書けばよいですか？</summary>
          ...
          <details>
            <summary>Q. カナダ経由とアメリカ経由、どちらが乗り継ぎしやすいですか？</summary>
