    ...
    <article class="article-body">
      ...
      <section id="sec-07" class="fade-up">
        ...
        <div class="faq" style="margin-top:32px">
          <details open>
            <summary>Q. ハワイ旅行にESTAは本当に必要ですか？</summary>
          ...
          <details>
            <summary>Q. ハワイへの食品の持ち込みで注意することは何ですか？</summary>
          ...
          <details>
            <summary>Q. ホノルル空港の入国審査にはどれくらい時間がかかりますか？</summary>
          ...
          <details>
            <summary>Q. ESTA申請時にハワイの滞在先住所はどう書けばよいですか？</summary>
          ...
          <details>
            <summary>Q. ハワイ旅行で使ったESTAは他のアメリカの都市への旅行にも使えますか？</summary>
