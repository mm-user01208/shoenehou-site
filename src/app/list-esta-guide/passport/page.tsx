  ...
  <div class="article-main__inner">
    ...
    <article class="article-body">
      ...
      <section id="sec-02" class="fade-up">
        ...
        <p>ESTAの再申請は、CBP公式サイト(esta.cbp.dhs.gov)または ESTA Mobileアプリから行うことができます。再申請の手順は初回の申請と同じで、新しいパスポートの情報を入力して申請手続きを行います。再申請にも1人あたり40.27ドル(2026年8月現在)の申請手数料が発生します。なお、ESTAには「更新」の制度はなく、再申請は新たな申請として扱われます。</p>
      ...
      <section id="sec-07" class="fade-up">
        ...
        <div class="faq" style="margin-top:32px">
          <details open>
            ...
            <div class="answer"><p>いいえ、パスポートを更新してもESTAは自動的に更新されません。ESTAはパスポート番号に紐づけられているため、パスポートを更新すると(パスポート番号が変わると)、それまで取得していたESTAは新しいパスポートでは使用できなくなります。新しいパスポートの情報を使用して、改めてESTAの再申請を行う必要があります。再申請にも1人あたり40.27ドルの申請手数料が発生します。</p></div>
          </details>
          <details>
