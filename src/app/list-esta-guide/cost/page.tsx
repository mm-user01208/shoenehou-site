...
const PAGE_DESCRIPTION = 'ESTA申請の料金を徹底解説。公式サイトでの申請費用は$40.27(約6,100円)、代行サイトの相場は5,000〜15,000円です。支払い方法や代行サイトのメリットもご紹介します。';
...
<section class="article-hero">
  <div class="article-hero__inner">
    ...
    <p class="article__lede">ESTA(エスタ)の申請には手数料がかかります。公式サイト(CBP)から直接申請する場合の料金は$40.27(約6,100円)ですが、日本語対応の代行サイトを利用する場合は別途サービス料が加算されるため、費用が異なります。本記事では、ESTA申請にかかる料金の内訳、代行サイトとの料金比較、支払い方法について詳しく解説します。</p>
  </div>
</section>
  ...
  <div class="article-main__inner">
    ...
    <article class="article-body">
      ...
      <section id="sec-01" class="fade-up">
        ...
        <p>ESTA(エスタ)の公式申請サイトは、CBP(アメリカ合衆国税関・国境警備局)が運営する「ESTA Online Center」です。公式サイトからESTAを申請した場合の手数料は$40.27(米ドル)です。日本円に換算すると約6,100円前後となりますが、為替レートの変動により金額は多少前後します。</p>
        <p>この$40.27の内訳は、ESTA運用手数料(Processing Fee)の$10.27、旅行促進手数料(Travel Promotion Fee)の$17、米国財務省一般基金への拠出分の$13で構成されています。申請料金は、審査結果に関わらず申請が処理された時点で発生します。申請が不承認となった場合は、ESTA運用手数料の$10.27が返金対象となりますが、残りの$30は処理費用として差し引かれます。</p>
        <p>なお、ESTAの申請料金は渡航者1名ごとに発生します。家族4人でアメリカに渡航する場合は、4名分の申請手数料として合計$161.08(約24,500円)が必要です。グループ申請を利用した場合でも、1名ごとの料金に変わりはありません。</p>
      </section>
      ...
      <section id="sec-05" class="fade-up">
        <h2>為替レートの影響</h2>
        <p>ESTAの公式申請手数料は$40.27(米ドル)で固定されていますが、日本円での支払い金額は為替レートの影響を受けます。クレジットカードで支払う場合、カード会社の為替レートが適用されるため、決済日の為替レートによって実際の請求金額が変動します。</p>
        <p>2026年8月時点の為替レートで換算すると、$40.27は約6,100円前後となります。ただし、円安が進んだ場合は支払い金額が増加し、円高の場合は減少します。例えば、1ドル=160円の場合は約6,440円、1ドル=140円の場合は約5,640円となります。</p>
      ...
      <section id="sec-06" class="fade-up">
        ...
        <div class="faq" style="margin-top:32px">
          <details open>
            ...
            <div class="answer"><p>公式サイト(CBP)からESTAを申請した場合の手数料は$40.27(米ドル)です。日本円に換算すると約6,100円前後ですが、為替レートの変動により金額は前後します。この料金は渡航者1名ごとに発生します。</p></div>
          </details>
          <details>
            <summary>ESTA申請が拒否された場合でも料金はかかりますか？</summary>
            <div class="answer"><p>はい、申請が拒否された場合でも料金は発生します。不承認の場合はESTA運用手数料の$10.27が返金対象となりますが、残りの$30は処理費用として差し引かれます。</p></div>
          </details>
          <details>
            <summary>代行サイトと公式サイトの違いは何ですか？</summary>
            <div class="answer"><p>公式サイトはCBP(アメリカ合衆国税関・国境警備局)が直接運営しており、申請料金は$40.27です。代行サイトは民間企業が運営しており、公式の申請手数料に加えてサービス料が上乗せされるため、料金は5,000円〜15,000円程度になります。代行サイトでは日本語サポートや入力チェックなどのサービスが含まれます。</p></div>
          </details>
          <details>
...
export default function Page() {
  return (<><JsonLd data={PAGE_JSON_LD} /><div className="redesign-detail" dangerouslySetInnerHTML={{ __html: BODY_HTML }} /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Q. ESTA申請の公式料金はいくらですか？", "acceptedAnswer": {"@type": "Answer", "text": "公式サイト(CBP)からESTAを申請した場合の手数料は$40.27(米ドル)です。日本円に換算すると約6,100円前後ですが、為替レートの変動により金額は前後します。この料金は渡航者1名ごとに発生します。"}}, {"@type": "Question", "name": "Q. ESTA申請が拒否された場合でも料金はかかりますか？", "acceptedAnswer": {"@type": "Answer", "text": "はい、申請が拒否された場合でも料金は発生します。不承認の場合はESTA運用手数料の$10.27が返金対象となりますが、残りの$30は処理費用として差し引かれます。"}}, {"@type": "Question", "name": "Q. 代行サイトと公式サイトの違いは何ですか？", "acceptedAnswer": {"@type": "Answer", "text": "公式サイトはCBP(アメリカ合衆国税関・国境警備局)が直接運営しており、申請料金は$40.27です。代行サイトは民間企業が運営しており、公式の申請手数料に加えてサービス料が上乗せされるため、料金は5,000円〜15,000円程度になります。代行サイトでは日本語サポートや入力チェックなどのサービスが含まれます。"}}, {"@type": "Question", "name": "Q. ESTA申請の支払いにデビットカードは使えますか？", "acceptedAnswer": {"@type": "Answer", "text": "Visa、MasterCard、JCBなどのブランドロゴが付いたデビットカードであれば使用できる場合があります。ただし、カードの種類や発行元によっては決済が承認されないケースもあるため、クレジットカードの利用をおすすめします。PayPalでの支払いも可能です。"}}, {"@type": "Question", "name": "Q. 家族分のESTAをまとめて支払うことはできますか？", "acceptedAnswer": {"@type": "Answer", "text": "はい、グループ申請を利用すれば、代表者のクレジットカードで家族全員分の申請手数料をまとめて支払うことが可能です。ESTA申請の支払いに使用するクレジットカードは、申請者本人名義でなくても利用できます。"}}]}) }} /></>);
}
